...
Reference nodes for `System Misc`. Total: **15** nodes.
...
- **Notes:** Retrieve a value from a list.
- **Inputs:**
  - `List` (`FLOAT`)
  - `Index` (`INT`)
- **Outputs:**
...
- **Notes:** Count how many items are in a given list.
- **Inputs:**
  - `List` (`FLOAT`)
- **Outputs:**
  - `Length` (`INT`)
