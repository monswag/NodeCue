...
- External agent workflow through the standalone `nodecue-blender-node-skills` package and the official Blender MCP.
...
- The standalone skill package installs with `npx @nodecue/blender-node-skills install`.
