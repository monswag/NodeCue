...
- v0.1 alpha only targets Geometry Nodes.
- Blender 5.0 is the minimum supported version; most testing happens on 5.1. Node behavior can differ between Blender versions and skill rules follow the 5.0 manual.
- Shader Nodes and Compositing Nodes are not implemented yet.
